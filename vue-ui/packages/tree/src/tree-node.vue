    ...
    <div class="sw-tree-node__content"
      ...
      <span
        ...
        :class="[
          ...
          'sw-tree-node__expand-icon',
          tree.iconClass ? tree.iconClass : 'sw-icon-caret-right'
        ]"
      >
      </span>
      <sw-checkbox
      ...
      <span
        v-if="node.loading"
        class="sw-tree-node__loading-icon sw-icon-loading">
      </span>
          ...
          return (
            parent.renderContent
              ...
              : tree.$scopedSlots.default
                ...
                : <span class="sw-tree-node__label">{ node.label }</span>
          );
        }
      }
    },
