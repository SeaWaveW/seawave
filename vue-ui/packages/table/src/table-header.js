import Vue from 'vue';
import { hasClass, addClass, removeClass } from 'seawave-ui/src/utils/dom';
...
export default {
                    ...
                    <div class={ ['cell', column.filteredValue && column.filteredValue.length > 0 ? 'highlight' : '', column.labelClassName] }>
                      ...
                      }
                      {
                        column.filterable ? (<span
                          class="sw-table__column-filter-trigger"
                          on-click={ ($event) => this.handleFilterClick($event, column) }>
                          <i class={ ['sw-icon-arrow-down', column.filterOpened ? 'el-icon-arrow-up' : ''] }></i>
                        </span>) : ''
                      }
                    </div>
                  </th>))
  ...
  mounted() {
    // nextTick 是有必要的 https://github.com/SeaWaveW/seawave-ui/pull/11311
    this.$nextTick(() => {
  ...
  methods: {
    ...
    handleFilterClick(event, column) {
      ...
      cell = cell.querySelector('.sw-table__column-filter-trigger') || cell;
