...
class TableLayout {
  ...
  updateScrollY() {
    ...
    if (this.table.$el && bodyWrapper) {
      const body = bodyWrapper.querySelector('.sw-table__body');
  ...
  updateElsHeight() {
    ...
    // fix issue (https://github.com/SeaWaveW/seawave-ui/pull/16956)
    const headerTrElm = headerWrapper ? headerWrapper.querySelector('.sw-table__header tr') : null;
