<script>
  ...
  import SwRadio from 'seawave-ui/packages/radio';
  import { isEqual } from 'seawave-ui/src/utils/util';
  ...
  export default {
    ...
    methods: {
      ...
      renderCheckIcon(h) {
        return (
          <i class="sw-icon-check sw-cascader-node__prefix"></i>
        );
      },

      renderLoadingIcon(h) {
        return (
          <i class="sw-icon-loading sw-cascader-node__postfix"></i>
        );
      },

      renderExpandIcon(h) {
        return (
          <i class="sw-icon-arrow-right sw-cascader-node__postfix"></i>
        );
      },
      ...
      renderContent(h) {
        ...
        return (
          <span class="sw-cascader-node__label">{ vnode || node.label }</span>
        );
      }
    },
