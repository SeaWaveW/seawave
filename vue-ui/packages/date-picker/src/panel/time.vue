<template>
  <transition name="sw-zoom-in-top" @after-leave="$emit('dodestroy')">
    <div
      v-show="visible"
      class="sw-time-panel sw-popper"
      :class="popperClass">
      <div class="sw-time-panel__content" :class="{ 'has-seconds': showSeconds }">
        <time-spinner
          ref="spinner"
          @change="handleChange"
      ...
      <div class="sw-time-panel__footer">
        ...
        <button
          type="button"
          class="sw-time-panel__btn"
          :class="{confirm: !disabled}"
          @click="handleConfirm()">{{ t('sw.datepicker.confirm') }}</button>
      </div>
    </div>
  </transition>
</template>
...
<script type="text/babel">
  import { limitTimeRange, isDate, clearMilliseconds, timeWithinRange } from 'seawave-ui/src/utils/date-util';
