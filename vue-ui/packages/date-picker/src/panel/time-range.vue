<template>
  <transition
    ...
    <div
      v-show="visible"
      class="sw-time-range-picker sw-picker-panel sw-popper"
      :class="popperClass">
      <div class="sw-time-range-picker__content">
        <div class="sw-time-range-picker__cell">
          <div class="sw-time-range-picker__header">{{ t('sw.datepicker.startTime') }}</div>
          <div
            :class="{ 'has-seconds': showSeconds, 'is-arrow': arrowControl }"
            class="sw-time-range-picker__body sw-time-panel__content">
            <time-spinner
              ref="minSpinner"
        ...
        <div class="sw-time-range-picker__cell">
          <div class="sw-time-range-picker__header">{{ t('sw.datepicker.endTime') }}</div>
          <div
            :class="{ 'has-seconds': showSeconds, 'is-arrow': arrowControl }"
            class="sw-time-range-picker__body sw-time-panel__content">
            <time-spinner
      ...
      <div class="sw-time-panel__footer">
        <button
          type="button"
          class="sw-time-panel__btn cancel"
          @click="handleCancel()">{{ t('sw.datepicker.cancel') }}</button>
        <button
          type="button"
          class="sw-time-panel__btn confirm"
          @click="handleConfirm()"
          :disabled="btnDisabled">{{ t('sw.datepicker.confirm') }}</button>
      </div>
    </div>
  </transition>
</template>
