<template>
  <div class="sw-time-spinner" :class="{ 'has-seconds': showSeconds }">
    <template v-if="!arrowControl">
      <sw-scrollbar
        @mouseenter.native="emitSelectRange('hours')"
        @mousemove.native="adjustCurrentSpinner('hours')"
        class="sw-time-spinner__wrapper"
        wrap-style="max-height: inherit;"
        view-class="sw-time-spinner__list"
        noresize
        tag="ul"
        ref="hours">
        <li
    ...
    <template v-if="arrowControl">
      <div
        ...
        class="sw-time-spinner__wrapper is-arrow">
        <i v-repeat-click="decrease" class="sw-time-spinner__arrow sw-icon-arrow-up"></i>
        <i v-repeat-click="increase" class="sw-time-spinner__arrow sw-icon-arrow-down"></i>
        <ul class="sw-time-spinner__list" ref="hours">
          <li
            class="sw-time-spinner__item"
      ...
      <div
        ...
        <i v-repeat-click="decrease" class="sw-time-spinner__arrow sw-icon-arrow-up"></i>
        <i v-repeat-click="increase" class="sw-time-spinner__arrow sw-icon-arrow-down"></i>
        <ul class="sw-time-spinner__list" ref="minutes">
          <li
            class="sw-time-spinner__item"
      ...
      <div
        ...
        <i v-repeat-click="decrease" class="sw-time-spinner__arrow sw-icon-arrow-up"></i>
        <i v-repeat-click="increase" class="sw-time-spinner__arrow sw-icon-arrow-down"></i>
        <ul class="sw-time-spinner__list" ref="seconds">
          <li
...
<script type="text/babel">
  import { getRangeHours, getRangeMinutes, modifyTime } from 'seawave-ui/src/utils/date-util';
  import SwScrollbar from 'seawave-ui/packages/scrollbar';
  import RepeatClick from 'seawave-ui/src/directives/repeat-click';
