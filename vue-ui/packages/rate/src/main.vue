    ...
    <span
      ...
      <i
        ...
        <i
          ...
          :style="decimalStyle"
          class="sw-rate__decimal">
        </i>
      </i>
    </span>
    <span v-if="showText || showScore" class="sw-rate__text" :style="{ color: textColor }">{{ text }}</span>
  </div>
</template>

<script>
  import { hasClass } from 'seawave-ui/src/utils/dom';
  import { isObject } from 'seawave-ui/src/utils/types';
  ...
  export default {
    ...
    props: {
      ...
      iconClasses: {
        type: [Array, Object],
        default() {
          return ['sw-icon-star-on', 'sw-icon-star-on', 'sw-icon-star-on'];
        }
      },
      voidIconClass: {
        type: String,
        default: 'sw-icon-star-off'
      },
      disabledVoidIconClass: {
        type: String,
        default: 'sw-icon-star-on'
      },
      disabled: {
        type: Boolean,
        default: false
    ...
    methods: {
      ...
      setCurrentValue(value, event) {
        ...
        if (this.allowHalf) {
          ...
          if (hasClass(target, 'sw-rate__item')) {
            target = target.querySelector('.sw-rate__icon');
          }
          if (hasClass(target, 'sw-rate__decimal')) {
