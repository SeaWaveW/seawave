'use strict';
// make new-lang 语言名
// 为组件库体检新语言，比如i18n的 fr 法语
// 分别为涉及到的文件(component.json、page.json、route.json、nav.config.json)设置该语言的相关配置
// 具体的配置项默认为英文，你只需要在相应的文件中将这些英文配置项翻译为对应的语言即可
console.log();
process.on('exit', () => {
  console.log();
});
...
// 将被改动后的 componentFile写回到component.json
